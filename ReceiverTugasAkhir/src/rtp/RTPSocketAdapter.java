...
public class RTPSocketAdapter implements RTPConnector {
    ...
    public RTPSocketAdapter(InetAddress addr, int port, String Message, String _mode) throws IOException {
        this(addr, port, 1, Message, _mode );
    }

    public RTPSocketAdapter(InetAddress addr, int port, int ttl, String Message, String _mode) throws IOException {

        this.addr = addr;
        this.port = port;

        try {
            dataSock = new NewRTPSocket(port, Message,_mode);
            ctrlSock = new NewRTPSocket(port + 1, Message,_mode);
