...
public class RTPSocketAdapter implements RTPConnector {
    ...
    private NewRTPSocket dataSock;
    private NewRTPSocket ctrlSock;
    private InetAddress addr;
    private int port;
    SockInputStream dataInStrm = null, ctrlInStrm = null;
    SockOutputStream dataOutStrm = null, ctrlOutStrm = null;

    public RTPSocketAdapter(InetAddress addr, int port, String Message, String _mode, uiReceiver ui) throws IOException {
        this(addr, port, 1, Message, _mode, ui);
    }

    public RTPSocketAdapter(InetAddress addr, int port, int ttl, String Message, String _mode, uiReceiver ui) throws IOException {

        this.addr = addr;
        this.port = port;
        
        try {
            dataSock = new NewRTPSocket(port, Message,_mode, ui);
            ctrlSock = new NewRTPSocket(port + 1, Message,_mode, ui);
